...
Page({
  data: {
    list: [
      ...
      { alphabet: 'h', datas: ['河传', '河满子', '贺圣朝', '贺新郎', '画堂春', '换巢鸾凤', '浣溪沙', '喝火令', '汉宫春', '黄莺儿', '河渎神', '荷叶杯'] },
      { alphabet: 'j', datas: ['江南春', '解佩令', '解语花', '锦缠道', '荆州亭', '酒泉子', '江城子', '江城子（定格）', '金人捧露盘', '锦堂春慢', '剑器近', '绛都春'] },
      { alphabet: 'k', datas: [] },
      { alphabet: 'l', datas: ['浪淘沙慢曲', '离亭燕', '临江仙', '柳梢青', '六州歌头', '兰陵王', '六丑'] },
      { alphabet: 'm', datas: ['满庭芳', '摸鱼儿', '陌上花', '蓦山溪', '木兰花', '眉妩（百宜娇）', '木兰花慢'] },
      { alphabet: 'n', datas: ['南浦', '南乡子', '南乡子(2)', '念奴娇（变格）', '念奴娇（定格）', '霓裳'] },
      ...
      { alphabet: 'w', datas: ['误佳期', '巫山一段云', '望江东', '望远行'] },
      { alphabet: 'x', datas: ['惜分飞', '喜迁莺', '相见欢', '潇湘神', '潇湘夜雨', '小重山', '行香子', '雪梅香', '惜红衣', '西河', '西吴曲'] },
      { alphabet: 'y', datas: ['瑶台聚八仙', '谒金门', '一斛珠', '一翦梅', '忆江南', '忆秦娥', '忆王孙', '永遇乐', '渔歌子', '渔家傲', '虞美人', '雨淋铃', '雨霖铃', '玉漏迟', '御街行', '玉蝴蝶', '扬州慢', '忆旧游', '夜飞鹊', '忆少年', '夜游宫', '燕山亭（宴山亭）', '宴清都', '夜半乐', '莺啼序', '忆馀杭'] },
  ...
  next: function (e) {
    ...
    console.log(keyword)
    wx.navigateTo({
      url: '/pages/index/poetry_library/poetry_rhythmic/poetry_rhythmic?keyword=' + keyword,
    })
  }
})
